const Hero = () => {
  return (
    <div className="main flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 sm:px-16 py-20 lg:py-0">
      ...
      <div className="lg:hidden w-full max-w-md mb-8 p-3">
        <div className="card p-2 bg-[#1111] border-2 border-black w-full aspect-square shadow-div rounded-2xl overflow-hidden">
      ...
      <div className="font-nunito-extrabold font-bold text-white text-center lg:text-left lg:w-1/2">
        ...
        <div className="flex justify-center text-black lg:justify-start gap-5 text-3xl">
      ...
      <div className="hidden lg:flex w-1/2 h-full items-center justify-center">
        <div className="card bg-[#1111] border-2 border-black h-[520px] w-[450px] max-w-[90%] shadow-div rounded-2xl overflow-hidden">
