const Procard = (props) => {
  return (
    <div className="relative w-[95%] sm:w-full max-w-sm mx-auto group scale-110">
      <div className=" absolute lg:top-[1rem] top-[3rem] bg-[#8120d6] w-[90%] sm:w-[80%] rounded-2xl p-3 h-80 sm:h-[100%] z-0">
      ...
      <div className=" pro-card relative bg-[#000000] w-[90%] sm:w-[80%] rounded-2xl p-6 h-[340px] sm:h-[320px] z-10 shadow-lg">
