...
const Procard = ({ link, img, name, description, tags }) => {
  return (
    <motion.a
      ...
      className="relative block w-full h-full overflow-hidden rounded-2xl border border-gray-700 shadow-md backdrop-blur-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
    >
      {/* Project Image */}
      ...
      {/* Project Details */}
      <div className="p-4 bg-gray-900 text-white rounded-b-2xl">
